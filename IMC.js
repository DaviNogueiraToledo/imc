...
function calcular(event) {
	...
	if (imc < 17) {
		...
		resultado.innerHTML = "<br/> Seu resultado foi: " + imc.toFixed(2) + "<br/> Cuidado, obesidade de 1° grau!";
    } else if (imc >= 35 && imc <= 39.99) {
		resultado.innerHTML = "<br/> Seu resultado foi: " + imc.toFixed(2) + "<br/> Cuidado, obesidade de 2° grau!";
    } else if (imc >= 40) {
		resultado.innerHTML = "<br/> Seu resultado foi: " + imc.toFixed(2) + "<br/> Cuidado, obesidade de 3° grau!";
	}
